...
public class RegistryKlientImplTest {

    @Mock
    private WebResource mockWebResource;
    @Mock
    private com.sun.jersey.api.client.WebResource.Builder mockWebResourceBuilder;
    @Mock
    ...
    public void skalReturnereHvisFinnesIRegistry() {
        RegistryOppslagKlient oppslagKlient = new RegistryKlientBuilder(mockWebResource)
    ...
    public void skalReturnereTjenesteattributter() throws Exception {
        RegistryOppslagKlient oppslagKlient =
                new RegistryKlientBuilder(mockWebResource)
                        .overstyringProperty("false")
                        .byggRegistryKlient();

        ImmutableMap<String, String> tjenesteattributter = ImmutableMap.of(STSTjenesteKonstanter.STS_SIKKERHETSPOLICY_TJENESTEATTRIBUTT,
        ...
        assertThat(oppslagKlient.hentTjenesteAttributter("urn:tjeneste")).includes(
                MapAssert.entry(STSTjenesteKonstanter.STS_SIKKERHETSPOLICY_TJENESTEATTRIBUTT,
                        SikkerhetspolicyOppslagstjeneste.AKTIVERT.getValue()));
    }
    ...
    public void skalFeileHvisObligatoriskOppslagFeiler() {
        RegistryKlient klient = new RegistryKlientBuilder(mockWebResource)
    ...
    public void skalReturnereNullHvisIkkeFinnesIRegistry() {
        RegistryKlient oppslagKlient = new RegistryKlientBuilder(mockWebResource)
                .byggRegistryKlient();
    ...
    public void skalResendeRegistreringHvisFeilet() {
        ...
        RegistryKlientImpl klient = (RegistryKlientImpl) new RegistryKlientBuilder(mockWebResource)
                .tjenesteregistrering(registrering)
                .timerStartDelay(0)
                .byggRegistryKlient();
    ...
    public void skalVareTraadsikkerForCaching() {
        final RegistryKlientImpl oppslagKlient = (RegistryKlientImpl) new RegistryKlientBuilder(mockWebResource)
                .overstyringProperty("false")
                .autoRefreshCachedeOppslag(false)
                .byggRegistryKlient();
    ...
    private RegistreringDTO lagRegistreringDTO() {
        return RegistreringDTO.medTilbyderNavn("test").tjeneste("urn:tjeneste", null, null).bygg();
    }
